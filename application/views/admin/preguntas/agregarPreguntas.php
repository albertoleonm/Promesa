...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12">
            ...
            <br>
            <br>
                <form method="post" action="add_Preguntas" >
                    <label for="pregunta">Pregunta </label>
                    <input type="text" name="pregunta" id="pregunta" maxlength="100" class="form-control input">
                    <br>
                    <label for="respuesta">Respuesta</label>
                    <textarea name="respuesta" id="respuesta" class="form-control input" maxlength="300" cols="10" rows="3"></textarea>
                    <br>
                    <input type="hidden" name="idUsuario" value="<?=$this->session->userdata('idUsuario')?>">
                    <br>
                    <center><button class="btn add-users" onclick="return validarPreguntas();">Crear pregunta</button></center>
                </form>
            </div>
        </div>
    </div>
...
<script>
    function validarPreguntas(){
        ...
        if(pregunta == '' || respuesta == ''){
            document.getElementById('error').innerHTML = '<i class="fas fa-times"></i> No puedes dejar campos vacios.';
            return false;
        }else{
            return true;
        }
