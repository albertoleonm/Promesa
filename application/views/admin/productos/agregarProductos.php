    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card-users">
                <form action="<?=base_url();?>admin/addProducto" method="POST" enctype="multipart/form-data">
                    <center><h3><i class="fas fa-truck-loading"></i> Agregar Productos</h3>
                </center>
                <br>
                <label for="nombreProducto">Nombre del producto:</label>
                <input type="text" name="nombreProducto" id="nombreProducto" maxlength="50" class="form-control">
                <br>
                ...
                <input type="text" name="ventaProducto" id="ventaProducto" maxlength="5" class="form-control">
                <br>
                <label for="stock">Stock:</label>
                <input type="number" name="stock" id="stock" max="100" min="1" class="form-control">
                <br>
